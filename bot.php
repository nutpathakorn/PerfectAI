	...
	foreach ($events['events'] as $event) {
		...
		if ($event['type'] == 'message' && $event['message']['type'] == 'text') 
		{
			...
			$text = 'สวัสดีครับ ผม PerfectAI เป็นระบบรับแจ้งปัญหาอัตโนมัติครับผม :)';
				...
				$text = 'สวัสดีครับ แจ้งปัญหาเริ่มด้วยการพิมพ์ \nรหัสพนักงาน+"@"+รายละเอียดปัญหา,สถานที่แจ้ง,เบอร์ติดต่อกลับ  ของคุณได้เลยครับ เช่น ( \n12345@คอมพิวเตอร์เปิดไม่ติดครับ,แผนกบัญชีชั้น17,เบอร์โทรศัพท์ 1888n\)';
			}
			else{
				$text = 'สวัสดีครับ แจ้งปัญหาเริ่มด้วยการพิมพ์ \nรหัสพนักงาน+"@"+รายละเอียดปัญหา,สถานที่แจ้ง,เบอร์ติดต่อกลับ  ของคุณได้เลยครับ เช่น ( \n12345@คอมพิวเตอร์เปิดไม่ติดครับ,แผนกบัญชีชั้น17,เบอร์โทรศัพท์ 1888\n)';
			}
		}
